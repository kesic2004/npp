#ifndef __REAL_KESIC_LEE_COMMON_GENERIC_STD_FUNCTION_DEFINE_H__
#define __REAL_KESIC_LEE_COMMON_GENERIC_STD_FUNCTION_DEFINE_H__ 1
...
#endif // !__REAL_KESIC_LEE_COMMON_GENERIC_STD_FUNCTION_DEFINE_H__
